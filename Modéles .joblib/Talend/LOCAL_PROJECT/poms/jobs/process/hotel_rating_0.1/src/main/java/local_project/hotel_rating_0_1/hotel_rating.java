...
package local_project.hotel_rating_0_1;
 ...
 * @status
 */
public class hotel_rating implements TalendJob {
	...
	private final String jobName = "hotel_rating";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(hotel_rating.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_hotel_rating = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_hotel_rating = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_hotel_rating.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_hotel_rating.length == 0) {
						commonByteArray_LOCAL_PROJECT_hotel_rating = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_hotel_rating = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_hotel_rating, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_hotel_rating, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_hotel_rating, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_hotel_rating, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_hotel_rating) {
				...
				try {
					...
					this.rate = readString(dis);

					this.stars = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.rate, dos);

				// String

				writeString(this.stars, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LAHf9IPPwkpQD/32LKh1u+AqbORWXnw/RZ/awsotGQ0Gr3hWZk8=");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "hotel-ratings11";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "hotel-ratings11";
				}
				int count_tDBOutput_2 = 0;

				String insert_tDBOutput_2 = "INSERT INTO [" + tableName_tDBOutput_2
						+ "] ([name],[rate],[stars]) VALUES (?,?,?)";
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"C:/Users/User/Downloads/hotel_ratings (1).csv"/** End field tFileInputDelimited_2:FILENAME */
				;
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.rate = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.stars = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.name == null) {
								...
								pstmt_tDBOutput_2.setString(1, row1.name);
							}

							if (row1.rate == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row1.rate);
							}

							if (row1.stars == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row1.stars);
							}
	...
	public static void main(String[] args) {
		final hotel_rating hotel_ratingClass = new hotel_rating();

		int exitCode = hotel_ratingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = hotel_rating.class.getClassLoader()
					.getResourceAsStream("local_project/hotel_rating_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = hotel_rating.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : hotel_rating");
		}
...
/************************************************************************************************
 * 54043 characters generated by Talend Open Studio for Data Integration on the
 * 10 mars 2025 à 22:19:37 WAT
 ************************************************************************************************/